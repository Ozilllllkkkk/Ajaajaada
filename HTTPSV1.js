...
if (process.argv.length != 0x4) {
  console.log("Usage: node HTTPSV1.js <HOST> <TIME>");
  console.log("example: node HTTPV1.js website.com time");
  console.log("Touched By DarkCeast");
  console.log("Important! remove the http:// or https://")
  process.exit();
}
